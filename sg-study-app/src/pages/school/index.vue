					...
					<view class="course-grid">
						<view v-for="c in courses" :key="c.title" class="course-item">
							...
							<view class="course-imgs">
								<image v-for="image in c.imgs" :key="image" class="course-img" :src="img(image)" mode="aspectFill" />
							</view>
						</view>
					</view>
				</view>
					...
					<view class="trip">
						<view v-for="d in itinerary" :key="d.day" class="trip-item sg-card">
							...
							<view v-if="d.imgs && d.imgs.length" class="trip-imgs">
								<image v-for="image in d.imgs" :key="image" class="trip-img" :src="img(image)" mode="aspectFill" />
							</view>
						</view>
					</view>
				</view>
