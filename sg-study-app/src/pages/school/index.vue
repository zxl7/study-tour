					...
					<view class="course-grid">
						<view v-for="c in courses" :key="c.title" class="course-item">
							...
							<view class="course-imgs">
								<image v-for="image in c.imgs" :key="image" class="course-img" :src="img(image)" mode="aspectFill" @tap="previewImg(image)" />
							</view>
						</view>
					</view>
				</view>
					...
					<view class="trip">
						<view v-for="d in itinerary" :key="d.day" class="trip-item sg-card">
							...
							<view v-if="d.imgs && d.imgs.length" class="trip-imgs">
								<image v-for="image in d.imgs" :key="image" class="trip-img" :src="img(image)" mode="aspectFill" @tap="previewImg(image)" />
							</view>
						</view>
					</view>
				</view>
...
const courses = [
	...
	},
	{
		...
		imgs: ['pkg/common/English.jpg', 'pkg/common/English_1.jpg'],
	},
	{
		title: '创意STEAM',
...
const itinerary = [
	...
	},
	{
		...
		imgs: ['pkg/itinerary/Tour_6.jpg', 'pkg/itinerary/Tour_7.jpg'],
	},
	{
		day: 'Day 3',
 ...
 */
const foods = [
	{ name: '肉骨茶', img: 'pkg/food/Bak_Kut_Teh.jpeg' },
	{ name: '海南鸡饭', img: 'pkg/food/Chicken_Rice.jpeg' },
	{ name: '辣椒螃蟹', img: 'pkg/food/Chilli_Crab.jpg' },
	{ name: 'Laksa', img: 'pkg/food/Laksa.jpg' },
]
