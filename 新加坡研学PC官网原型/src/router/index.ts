    ...
    children: [
      {
        ...
        name: "Home",
        component: Home,
        meta: { title: { zh: "首页 - 盛昌利民", en: "Home - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "growth-camp",
        name: "GrowthCamp",
        component: GrowthCamp,
        meta: { title: { zh: "新加坡成长营 - 盛昌利民", en: "Growth Camp - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "mini-study",
        name: "MiniStudy",
        component: MiniStudy,
        meta: { title: { zh: "新加坡微留学 - 盛昌利民", en: "Mini Study - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "ep-pass",
        name: "EpPass",
        component: EpPass,
        meta: { title: { zh: "人才准证EP - 盛昌利民", en: "EP Pass - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "school-camp",
        name: "SchoolCamp",
      ...
      },
      {
        ...
        name: "About",
        component: AboutPage,
        meta: { title: { zh: "集团简介 - 盛昌利民", en: "About - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "family-office",
        name: "FamilyOffice",
        component: FamilyOfficePage,
        meta: { title: { zh: "家族办公室 - 盛昌利民", en: "Family Office - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "self-employed-pass",
        name: "SelfEmployedPass",
        component: SelfEmployedPassPage,
        meta: { title: { zh: "自雇准证办理 - 盛昌利民", en: "Self-Employed EP - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "pr-application",
        name: "PrApplication",
        component: PrApplicationPage,
        meta: { title: { zh: "PR永居申请 - 盛昌利民", en: "PR Application - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "terms",
        name: "Terms",
        component: TermsPage,
        meta: { title: { zh: "服务条款 - 盛昌利民", en: "Terms - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "privacy",
        name: "Privacy",
        component: PrivacyPage,
        meta: { title: { zh: "隐私政策 - 盛昌利民", en: "Privacy - SG Study 2026" } satisfies I18nText },
      },
      {
        path: "partnership",
        name: "Partnership",
        component: PartnershipPage,
        meta: { title: { zh: "合作咨询 - 盛昌利民", en: "Partnership - SG Study 2026" } satisfies I18nText },
      },
      {
        // 404
        path: "/:pathMatch(.*)*",
        redirect: "/home",
        meta: { title: { zh: "页面不存在 - 盛昌利民", en: "404 Not Found" } satisfies I18nText },
      },
    ],
  },
]
